        ...
        <div class="carousel-fixed-item center">
            @if(!Auth::check())
                <a href=" {{route('register') }}"
                   class="btn waves-effect white orange-text text-accent-2">S'inscrire</a>
            @else
    ...
    @if(Auth::check())
        ...
        <ul class="collection">
            <li class="collection-item avatar">
                ...
                <p>Un espace profil permettant de personnaliser votre profil ainsi que de mettre à jour vos
                    informations</p>
            </li>
            <li class="collection-item avatar">
            ...
            @if(Auth::user()->type_user == 1 or Auth::user()->type_user == 0)
                ...
                <li class="collection-item avatar">
                    ...
                    <p>Créer un exercice : soumettre un exercice à l'ensemble du site, l'assigner à un groupe
                        d'étudiants</p>
                </li>
            @endif
        </ul>
                ...
                <div class="card">
                    <div class="card-content white-text">
                        ...
                        <p class="card-subtitle grey-text text-darken-2">
                            ...
                            Enfin l’étudiant pourra suivre les différents exercices qu’il a résolu ou qui sont en cours
                            de
                            résolution.<br>
                        </p>
                    </div>
            ...
            <div class="col s6">
                <div class="card">
                    <div class="card-content white-text">
                        ...
                        <p class="card-subtitle grey-text text-darken-2">
                            L’enseignant possède les même droits qu’un étudiant mais a aussi la possibilité de pouvoir
                            créer
                    ...
                    @if(Auth::check())
                        <div class="card-action center">
                            <p><a href="{{ route('exercise.create') }}"><i class="small material-icons">play_arrow</i>ajouter
                                    un exercice</a></p>
                            <p><a href="{{ route('groupe.create') }}"><i class="small material-icons">play_arrow</i>créer
                                    un
                                    groupe</a></p>
                            @endif
                        </div>
